...
var postsBody = document.querySelector("#content-article");
...
function getUsers() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fetch(usersPage)];
        case 1:
          response = _a.sent();
...
function getPosts() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fetch(postsPage)];
        case 1:
          response = _a.sent();
          return [4 /*yield*/, response.json()];
        case 2:
...
createPost("Novo título", "Corpo da nova postagem.");
function createPost(title, body) {
  return __awaiter(this, void 0, void 0, function () {
    var postData, response, post, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 3:
          post = _a.sent();
          console.log("Postagem criada com sucesso:", post);
          return [3 /*break*/, 5];
        case 4:
          error_2 = _a.sent();
