...
function getUsers() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://jmrfrosa.github.io/edit-jsts-dec2023.github.io/data/users.json")];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    a.href = postsPage;
                    return [4 /*yield*/, fetch("https://jmrfrosa.github.io/edit-jsts-dec2023.github.io/data/posts.json")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2: return [2 /*return*/, _a.sent()];
